...
async def voice_websocket_endpoint(websocket: WebSocket, conversation_id: str):
    ...
    language_configs = {
        "Bengali": {
            "code": "bn-BD",
            "greeting": "আসসালামুআলাইকুম! ইউনিফাইড আইটি তে কল করার জন্য ধন্যবাদ। ইউনিফাইড আইটির দুটি প্রধান বিশেষত্ব হলো AWS-এর তুলনায় কম ল্যাটেন্সিতে দ্রুত সেবা এবং ইন্টারনেটের ওপর নির্ভরতা ছাড়াই নিরাপদ প্রাইভেট নেটওয়ার্কের মাধ্যমে সংযুক্ত থাকার সুবিধা। কিভাবে আপনাকে সাহায্য করতে পারি?",
